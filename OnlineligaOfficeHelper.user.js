...
(function() {
    ...
    const Sponsor = {};
    const sponsors = {};
    let seasonValueMin = Number.MAX_VALUE;
    let seasonValueMax = 0;
    let seasonValuePromotedMin = Number.MAX_VALUE;
    let seasonValuePromotedMax = 0;
    ...
    Sponsor.calculateSponsorsBonuses = function() {
        ...
        $('div.sponsor-info-details-wrapper').each(function(i, el) {
            ...
            for(const key in valueDict){
                ...
                GM_setValue( "CalcSponsor_victories", victories )
                GM_setValue( "CalcSponsor_placement", placement )
            ...
            $(el).after('<div class="sponsor-seasonvalue" style="bottom: 25px; position: relative; left: 5px; width: fit-content">Prämie-Saison: <span id="sponsor-seasonvalue-'+i+'" style="width: fit-content">'+ paragraphString +'</span>');
            ...
            for(const key in sponsors) {
                let value = (sponsors[key][0] - seasonValueMin) / seasonValueMax;
    ...
    function generateSponsorCalcDiv() {
        ...
        const initVict = GM_getValue( "CalcSponsor_victories", 10 );
        const initPlacem = GM_getValue( "CalcSponsor_placement", 10 );
